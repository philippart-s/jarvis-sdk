package fr.wilda.jarvis.sdk.ovhcloud;
...
public class EmotionEvaluation {
    ...
    public static SortedMap<String, Double> toSortedMap(EmotionEvaluation emotion) {
    ...
    public static Map<String, Double> toMap(EmotionEvaluation emotion) {
